...
if __name__ == "__main__":
	...
	parser.add_argument("--storage-for-output", dest="storage_for_output", default="T1_DE_KIT_Disk", help="Specifies the storage element you want to write your outputs to. Default: %(default)s")
