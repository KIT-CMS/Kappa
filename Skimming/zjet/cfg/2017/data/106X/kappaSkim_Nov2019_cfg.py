...
if options.isData:
    process.pfFilter = cms.EDFilter('CandViewCountFilter',
        ...
        #filter = cms.bool(False)  # add Filter option (deprecated)
    )
...
process.kappaTuple.Electrons.electrons.src = cms.InputTag("calibratedPatElectrons")
# TODO: check which one of these is actually used
...
setupElectrons(process, "calibratedPatElectrons")
...
updateJetCollection(process,
   ...
   jetCorrections = ('AK4PFchs', cms.vstring([]), 'None') # Update: Safe to always add 'L2L3Residual' as MC contains dummy L2L3Residual corrections (always set to 1)
)

updateJetCollection(process,
   jetSource = cms.InputTag('selectedPatJetsAK4PFCHS'),
   labelName = 'AK4UpdatedJEC',
   #jetCorrections = ('AK4PFchs', cms.vstring(['L1FastJet', 'L2Relative', 'L3Absolute', 'L2L3Residual']), 'None')  # Update: Safe to always add 'L2L3Residual' as MC contains dummy L2L3Residual corrections (always set to 1)
   jetCorrections = ('AK4PFchsJTB', cms.vstring([]), 'None') # Update: Safe to always add 'L2L3Residual' as MC contains dummy L2L3Residual corrections (always set to 1)
)

updateJetCollection(process,
   jetSource = cms.InputTag('selectedPatJetsAK8PFCHS'),
   ...
   jetCorrections = ('AK8PFchs', cms.vstring([]), 'None') # Update: Safe to always add 'L2L3Residual' as MC contains dummy L2L3Residual corrections (always set to 1)
)

updateJetCollection(process,
   jetSource = cms.InputTag('slimmedJetsPuppi'),
   labelName = 'PuppiUpdatedJEC',
   ...
   jetCorrections = ('AK4PFPuppi', cms.vstring([]), 'None') # Update: Safe to always add 'L2L3Residual' as MC contains dummy L2L3Residual corrections (always set to 1)
)

process.kappaTuple.PatJets.ak4PFJetsCHS = cms.PSet(src=cms.InputTag("updatedPatJetsUpdatedJEC"))
process.kappaTuple.PatJets.ak4PFJetsCHSoldCorr = cms.PSet(src=cms.InputTag("slimmedJets"))
process.kappaTuple.PatJets.ak8PFJetsCHS = cms.PSet(src=cms.InputTag("updatedPatJetsAK8UpdatedJEC"))
process.kappaTuple.PatJets.ak8PFJetsCHSoldCorr = cms.PSet(src=cms.InputTag("selectedPatJetsAK8PFCHS"))
process.kappaTuple.PatJets.ak4PFJetsPuppi = cms.PSet(src=cms.InputTag("updatedPatJetsPuppiUpdatedJEC"))
process.kappaTuple.PatJets.ak4PFJetsPuppioldCorr = cms.PSet(src=cms.InputTag("slimmedJetsPuppi"))
