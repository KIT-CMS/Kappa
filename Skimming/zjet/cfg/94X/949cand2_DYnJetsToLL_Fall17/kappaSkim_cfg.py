...
process.kappaTuple.Electrons.ids = cms.VInputTag(
    ...
    # cut based VIDs V2
    cms.InputTag("cutBasedElectronID-Fall17-94X-V2-veto"),
    cms.InputTag("cutBasedElectronID-Fall17-94X-V2-loose"),
    cms.InputTag("cutBasedElectronID-Fall17-94X-V2-medium"),
    cms.InputTag("cutBasedElectronID-Fall17-94X-V2-tight"),
    # MVA based VIDs V1
    ...
    # MVA based VIDs V2
    cms.InputTag("mvaEleID-Fall17-noIso-V2-wp90"),
    cms.InputTag("mvaEleID-Fall17-noIso-V2-wp80"),
    cms.InputTag("mvaEleID-Fall17-noIso-V2-wpLoose"),
    cms.InputTag("mvaEleID-Fall17-iso-V2-wp90"),
    cms.InputTag("mvaEleID-Fall17-iso-V2-wp80"),
    cms.InputTag("mvaEleID-Fall17-iso-V2-wpLoose"),
)
