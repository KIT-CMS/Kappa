...
_CMSSW_SCRAM_SUFFIX="egmSSbackport"
...
# EGM scale/smearing backport to 80X
git cms-merge-topic ikrav:egm_id_80X_v3_photons
git cms-merge-topic cms-egamma:EGScaleAndSmearLeg_8026 #a backport of the 94X code for 80X
git cms-addpkg EgammaAnalysis/ElectronTools
rm -rf EgammaAnalysis/ElectronTools/data/  # removes the data directory so can replace with the cms-data repo for this package
