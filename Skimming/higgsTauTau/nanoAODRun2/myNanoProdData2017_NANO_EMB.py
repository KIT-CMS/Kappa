...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/user/aakhmets/gc_storage/ElTau_data_2017_CMSSW944_desy/TauEmbedding_ElTau_data_2017_CMSSW944_Run2017D/99/merged_998.root'),
)
