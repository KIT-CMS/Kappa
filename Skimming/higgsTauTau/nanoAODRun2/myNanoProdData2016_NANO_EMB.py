...
# with command line options: myNanoProdData2016 -s NANO --data --eventcontent NANOAOD --datatier NANOAOD --no_exec --conditions 102X_dataRun2_v11 --era Run2_2016,run2_nanoAOD_94X2016 --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)))
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:myNanoProdData2016_PAT.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('myNanoProdData2016 nevts:1'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('myNanoProdData2016_NANO.root'),
